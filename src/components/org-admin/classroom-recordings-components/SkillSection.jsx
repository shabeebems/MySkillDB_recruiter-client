    ...
    <section className="scroll-mt-28 sm:scroll-mt-32 md:scroll-mt-24 min-w-0">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 sm:gap-3 mb-3 sm:mb-4 md:mb-5 sticky top-[100px] sm:top-[110px] md:top-28 bg-neutral-50/95 backdrop-blur-md py-2.5 sm:py-3 z-20 px-2 sm:px-3 rounded-lg sm:rounded-xl border-b border-neutral-200/50 sm:border-none min-w-0">
        <div className="flex items-center gap-2.5 sm:gap-3 flex-1 min-w-0">
          <div className="w-7 h-7 sm:w-8 sm:h-8 md:w-10 md:h-10 bg-white rounded-lg sm:rounded-xl flex items-center justify-center shadow-sm ring-1 ring-black/5 text-purple-600 flex-shrink-0">
            <i className="fas fa-code text-[10px] sm:text-xs md:text-sm"></i>
          </div>
          <div className="min-w-0 flex-1 overflow-hidden">
            <h3 className="text-sm sm:text-base md:text-lg font-semibold text-neutral-900 tracking-tight truncate">{skill.name}</h3>
        ...
        >
          <div className="w-4 h-4 sm:w-5 sm:h-5 bg-purple-50 text-purple-600 rounded-full flex items-center justify-center group-hover:bg-purple-600 group-hover:text-white transition-colors">
