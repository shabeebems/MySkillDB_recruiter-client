...
// Template 1: Modern (Indigo accents) – extracted from JobCV
const JobCVTemplate1 = ({ cv }) => {
  if (!cv) return null;
            ...
            <div key={skillType} className="mb-4">
              ...
              <div className="grid grid-cols-2 gap-3 skills-grid">
                {skillsOfType.map((skill) => (
                  <div
                    key={skill.id}
                    className="skill-card bg-white rounded-lg p-3 border border-slate-200 shadow-sm avoid-break"
                  >
                    <div className="mb-2">
                            ...
                            {skill.testimonials
                              ...
                              .map((testimonial, index) => (
                                <div
                                  ...
                                  className="pl-2 border-l-2 border-slate-400 bg-slate-50 p-2 rounded-r"
                                >
